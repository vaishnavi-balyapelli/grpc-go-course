...
type SqrtRequest struct {
	...
	Number int32 `protobuf:"varint,1,opt,name=number,proto3" json:"number,omitempty"` //could be unit32 so that client cannot send negative numbers
}
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x76, 0x61, 0x69, 0x73, 0x68, 0x6e, 0x61, 0x76, 0x69, 0x2d,
	0x62, 0x61, 0x6c, 0x79, 0x61, 0x70, 0x65, 0x6c, 0x6c, 0x69, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d,
